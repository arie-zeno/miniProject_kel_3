...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2023 at 10:27 AM
...
--
ALTER TABLE `penduduk`
  ADD CONSTRAINT `fk_kecamatan` FOREIGN KEY (`id_kecamatan`) REFERENCES `penduduk` (`NIK`),
  ADD CONSTRAINT `fk_kelurahan` FOREIGN KEY (`id_kelurahan`) REFERENCES `penduduk` (`NIK`),
  ADD CONSTRAINT `fk_kota/kabupaten` FOREIGN KEY (`id_kota/kabupaten`) REFERENCES `penduduk` (`NIK`),
  ADD CONSTRAINT `fk_pekerjaan` FOREIGN KEY (`id_pekerjaan`) REFERENCES `penduduk` (`NIK`),
  ADD CONSTRAINT `fk_pendidikan` FOREIGN KEY (`id_pendidikan`) REFERENCES `penduduk` (`NIK`),
  ADD CONSTRAINT `fk_provinsi` FOREIGN KEY (`id_provinsi`) REFERENCES `penduduk` (`NIK`);
COMMIT;
